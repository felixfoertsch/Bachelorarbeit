...
\begin{mdframed}[style=onto, frametitle={Project\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-1, frametitle={Project\_Sales\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-1, frametitle={Project\_Initiation\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-2, frametitle={Project\_Goal\_Development\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-2, frametitle={Project\_Risk\_Assessment\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-2, frametitle={Project\_Team\_Making\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-3, frametitle={Project\_Team\_Application\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-3, frametitle={Project\_Team\_Selection\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-1, frametitle={Project\_Execution\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-1, frametitle={Project\_Finalization\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-2, frametitle={Project\_Documentation\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-2, frametitle={Project\_Invoicing\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-2, frametitle={Project\_Evaluation\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-2, frametitle={Project\_Taxation\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto, frametitle={Human\_Ressource\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-1, frametitle={Recruiting\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-2, frametitle={Advertising\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-1, frametitle={Onboarding\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-1, frametitle={Career\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-2, frametitle={Education\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-3, frametitle={Internal\_Education\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-3, frametitle={External\_Education\_Process}]
	{% Begin box content
		
	} % End box content
\end{mdframed}

\begin{mdframed}[style=onto-1, frametitle={Offboarding\_Process}]
	{% Begin box content
